...
public class httpbenchmark {
	...
	public static void main(String[] args) {
		...
		if(args.length == 7){
			...
			helplib.disinfo(httpbenchmark.class.getSimpleName() + ".jar");
		...
		try {
		    ...
		    try {
		    	testreport.pub(st, et, tn, client_num, test_time, total_req, total_res, total_err, qps, avg_latency, below_10, between_10_20, between_20_30, over_30);
		    	...
		    	q.disstat();
		    	mailsend.run(mailserver, sender, receivers, st, et, tn, client_num, test_time, total_req, total_res, total_err, qps, avg_latency, below_10, between_10_20, between_20_30, over_30);
			    q.stop();
