...
@Sharable
public class httpbenchmarkhandler extends ChannelInboundHandlerAdapter {
	private String host;
	//private int port;
	...
	public httpbenchmarkhandler(String host, int port, long end_time, int print_res, JSONObject jsondata) {
		...
		loglib.loginit();
		this.logger = LogManager.getLogger(httpbenchmarkhandler.class.getName());
	}
