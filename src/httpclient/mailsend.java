...
public class mailsend {
	...
	public static void  run(String mailserver, String sender, String receivers[],
		...
		String subject = "【测试报告】easysocketbenchmark性能测试报告";
		String content = "<div style='color:black;text-align:center;display:block;font-size:20px;font-family:微软雅黑'>easysocketbenchmark性能测试报告</div>";
		content += "<div style='font-family:微软雅黑;font-size:12px;font-style:italic;text-align:center;'>";
		content += "<a href='https://github.com/JunneYang/easysocketbenchmark'>@easysocketbenchmark</a> 2014";
		content += "</div>";
	    ...
	    new mailsend().send(mailserver, sender, receivers, subject, content);
	}
